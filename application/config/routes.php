...
$route["^(en|es)/eventos/(:num)/(:any).html"] = 'celsius/evento/$1/$2/$3';
$route["^(en|es)/events/(:num)/(:any).html"] = 'celsius/evento/$1/$2/$3';
...
$route["^(en|es)/congresos/(:num)/(:any).html"] = 'celsius/congreso/$1/$2/$3';
$route["^(en|es)/congress/(:num)/(:any).html"] = 'celsius/congreso/$1/$2/$3';
...
$route["^(en|es)/search"] = 'celsius/search/$1';
