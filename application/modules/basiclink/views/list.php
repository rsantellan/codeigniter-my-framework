...
<table id="table_data">
  ...
  <tbody>
    ...
    <tr id="table_row_<?php echo $object->id;?>">
      ...
      <td>
        <a href="<?php echo site_url("basiclink/edit/".$object->id);?>">
          Editar
        </a>
        <a href="javascript:void(0)" onclick="return adminManager.getInstance().deleteTableRow(<?php echo $object->id;?>, 'Esta seguro de querer eliminar?', '<?php echo site_url("basiclink/delete/".$object->id);?>');">
          Eliminar
        </a>
      </td>
    </tr>
...
<hr/>
<a href="<?php echo site_url("basiclink/add");?>">
  Agregar
</a>

<a class="colorbox_link iframe" href="<?php echo site_url("ordenable/sort/basiclink/link/name");?>" >
  Ordenar
</a>
