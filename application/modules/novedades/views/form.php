...
<div class="form-group <?php echo ($errorCopete)? 'has-error' : '';?>">
    <label for="copete">Copete</label>
    <?php echo form_textarea( array('class' => 'form-control', 'name' => 'copete', 'rows' => '5', 'cols' => '80', 'value' => html_entity_decode($object->getCopete(), ENT_COMPAT | 0, 'UTF-8')) )?>
    <p class="help-block"><?php echo ($errorCopete)? $errorCopete : 'Requerido';?></p>
</div>
