...
<body>
	<table cellpadding="0" cellspacing="0" style="width:800px; margin:25px;">
       ...
       <tr>
        	<td style="font-size:12px; padding:5px 0 5px 0; font-family:Lucida Grande, Lucida Sans Unicode, sans-serif; color:#353535; font-weight:bold; text-align:left">Nombre y Apellido:
       ...
       <tr>
        	<td style="font-size:12px; padding:5px 0 5px 0; font-family:Lucida Grande, Lucida Sans Unicode, sans-serif; color:#353535; font-weight:bold; text-align:left">Consulta:</td>
        </tr>
        <tr>
            <td><span style="font-size:12px; padding:0 0 10px 0; font-family:Lucida Grande, Lucida Sans Unicode, sans-serif; color:#353535; text-align:left; font-weight:normal;"><?php echo $comentario;?></span></td>
        </tr>
    </table>
</body>
</html>
