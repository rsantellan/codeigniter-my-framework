...
class departamentos extends MY_Controller{
    ...
    {
      parent::__construct();
      $this->data['menu_id'] = 'departamentos';
      if(!$this->isLogged())
      {
        //Si no esta logeado se tiene que ir a loguear
        $this->session->set_userdata('url_to_direct_on_login', 'departamentos/index');
        redirect('auth/login'); 
      }
    ...
    function index(){
      ...
      $this->data['objects_list'] = $this->departamento->retrieveAll(false);
      $this->data['content'] = "departamentos/list";
    ...
    function add()
    {
      ...
      $this->data['content'] = "departamentos/add";
      $this->data['object'] = new $this->departamento;
      $this->load->view("admin/layout", $this->data);
    }
    ...
    function edit($id)
    {
      ...
      $this->load->model('departamentos/departamento');
      $this->data['use_grid_16'] = false;
      $this->data['content'] = "departamentos/edit";
      $this->data['object'] = $this->departamento->getById($id);
      $this->load->view("admin/layout", $this->data);
    }
    ...
    function save()
    {
      ...
      if($is_valid)
      {
        ...
        redirect('departamentos/edit/'.$id);
      }
      else
      {
        $this->addModuleJavascript("admin", "adminManager.js");
    ...
    {
      $this->load->model('departamentos/departamento');
      $result = $this->departamento->deleteById($id);
      $salida['response'] = "OK";
      $this->output
