<h3>Listado de Noticias[<?php echo ($lang == 'es')? "Español" : "Ingles";?>]
    <?php $otherLang = ($lang == 'es')? "en" : "es"; ?>
    <a href="<?php echo site_url('news/index/'.$otherLang); ?>">
...
<table id="table_data">
  ...
  <tbody>
    ...
    <tr id="table_row_<?php echo $object->id;?>">
      ...
      <td>
        <a href="<?php echo site_url("news/edit/".$lang."/".$object->id);?>">
          Editar
        </a>
        <a href="javascript:void(0)" onclick="return adminManager.getInstance().deleteTableRow(<?php echo $object->id;?>, 'Esta seguro de querer eliminar?', '<?php echo site_url("news/delete/".$object->id);?>');">
          Eliminar
        </a>
      </td>
    </tr>
...
<hr/>
<a href="<?php echo site_url("news/add/".$lang);?>">
  Agregar
</a>

<a class="colorbox_link iframe" href="<?php echo site_url("ordenable/sortWithLang/news/mnew/name/".$lang);?>" >
  Ordenar
</a>
