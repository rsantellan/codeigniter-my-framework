        ...
        <div class="table-responsive">
          <table class="table table-striped table-bordered table-hover">
            <tbody>
              ...
              <tr>
                <td>nombre del tutor (si corresponde)</td>
                <td><strong><?php echo $object->tutor; ?></strong></td>
              </tr>
              <tr>
...
<div class="row">
  <div class="col-lg-6">
    <a class="btn btn-info" href="<?php echo site_url('llamados/index'); ?>"> Volver al indice </a>
  </div>
</div>
