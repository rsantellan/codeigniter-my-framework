...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  ...
  <body>
    ...
    <ul id="sortable">
      ...
      <?php foreach($sort_list as $object): ?>
        <li id="listItem_<?php echo $object->id;?>" class="ui-state-default">
          <span class="ui-icon ui-icon-arrowthick-2-n-s"></span><?php echo $object->nombre;?> <?php //echo $acta->ordinal; ?>
        </li>
      <?php endforeach; ?>
    </ul>
    ...
    $(document).ready(function() { 
      adminManager.getInstance().startSortable('sortable', '<?php echo site_url("proyectos/proyectoadmin/applySort");?>');
    });
