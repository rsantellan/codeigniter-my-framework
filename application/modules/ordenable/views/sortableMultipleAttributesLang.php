...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  ...
  <body>
    <h1>Ordenar</h1>
    <form onsubmit="return retrieveData(this)" action="<?php echo site_url("ordenable/retrieveDataMultipleLang");?>">
          ...
          <input type="hidden" name="middle_module" value="<?php echo $middle_module;?>"/>
          <input type="hidden" name="middle_model" value="<?php echo $middle_model;?>"/>
          <input type="hidden" name="middle_function" value="<?php echo $middle_function;?>"/>
