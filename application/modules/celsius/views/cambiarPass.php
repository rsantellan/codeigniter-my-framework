...
$attributes= array('class' => 'changepassform', 'style' => 'background-color: #FFFFFF;', 'onsubmit' => 'return changePassForm(this);');
?>
<?php echo form_open('celsius/changeUserPass', $attributes); ?>
<table>
	<tr>
...
<?php echo form_submit(array('id' => 'changePass', 'name' => 'guardar'), 'CambiarPass'); ?>
<?php echo form_close(); ?>
<div class="errores" id="formchangepasserrores" style="height: 70px; background-color: white; color: red">
