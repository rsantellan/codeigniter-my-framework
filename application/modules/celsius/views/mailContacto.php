...
<body>
	<table cellpadding="0" cellspacing="0" style="width:800px; margin:25px;">
        ...
        <tr>
        	<td style="height:30px; padding:15px 0; font-size:14px; font-weight:bold;text-transform:uppercase; font-family:Lucida Grande, Lucida Sans Unicode, sans-serif; color:#023b81;">Contacto</td>
        </tr>
       <tr>
        	<td style="font-size:12px; padding:5px 0 5px 0; font-family:Lucida Grande, Lucida Sans Unicode, sans-serif; color:#1a171b; font-weight:bold; text-align:left">Motivo de consulta:<span style="font-size:12px; padding:5px 0 5px 10px; font-family:Lucida Grande, Lucida Sans Unicode, sans-serif; color:#1a171b; text-align:left; font-weight:normal;"><?php echo $motivo;?></span></td>
        </tr>        
       <tr>
       ...
       <tr>
        	<td style="font-size:12px; padding:5px 0 5px 0; font-family:Lucida Grande, Lucida Sans Unicode, sans-serif; color:#1a171b; font-weight:bold; text-align:left">Empresa:<span style="font-size:12px; padding:5px 0 5px 10px; font-family:Lucida Grande, Lucida Sans Unicode, sans-serif; color:#1a171b; text-align:left; font-weight:normal;"><?php echo $empresa;?></span></td>
        </tr>
       <tr>
        	<td style="font-size:12px; padding:5px 0 5px 0; font-family:Lucida Grande, Lucida Sans Unicode, sans-serif; color:#1a171b; font-weight:bold; text-align:left">Cargo:<span style="font-size:12px; padding:5px 0 5px 10px; font-family:Lucida Grande, Lucida Sans Unicode, sans-serif; color:#1a171b; text-align:left; font-weight:normal;"><?php echo $cargo;?></span></td>
        </tr>
       <tr>
        	<td style="font-size:12px; padding:5px 0 5px 0; font-family:Lucida Grande, Lucida Sans Unicode, sans-serif; color:#1a171b; font-weight:bold; text-align:left">Consulta:<span style="font-size:12px; padding:5px 0 5px 10px; font-family:Lucida Grande, Lucida Sans Unicode, sans-serif; color:#1a171b; text-align:left; font-weight:normal;"><?php echo $consulta;?></span></td>
        </tr>
    </table>
</body>
</html>
