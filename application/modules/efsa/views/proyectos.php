...
<div class="content">
  <div class="content_int">
	<div class="bg_titles bg_titles_investigaciones">
		...
		<div class="sub_links"><a href="<?php echo site_url('facilidades.html');?>" ><?php echo lang('investigacion_facilidades_titulo');?></a><span>|</span><a href="<?php echo site_url('tesis-posgrado.html');?>"><?php echo lang('investigacion_tesis_titulo');?></a></div>
	</div>
