	  ...
	  <nav>
		<menu>
			<ul>
				...
				<li class="investigacion"><a href="<?php echo site_url('investigacion.html');?>" <?php if($menu == 'investigacion'):?> class="current"<?php endif;?>><?php echo lang('menu_investigacion');?></a></li>
